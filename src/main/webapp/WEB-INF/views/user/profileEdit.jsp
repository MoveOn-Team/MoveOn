    ...
    <form action="${pageContext.request.contextPath}/user/profileEdit" method="post" class="edit-content-form">
        ...
        <div class="section-group">
            ...
            <div class="edit-input-card">
                ...
                <input type="number" step="0.1" min="1" name="heightCm" id="height" class="card-input" value="${user.heightCm}" required>
            </div>

            <div class="edit-input-card mt-12">
                <label class="card-label">몸무게 (kg)</label>
                <input type="number" step="0.1" min="1" name="weightKg" id="weight" class="card-input" value="${user.weightKg}" required>
            </div>
        </div>
