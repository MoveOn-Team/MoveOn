 ...
 *
 * MOVE:ON 은 회원마다 다른 salt 를 users.salt 에 저장하므로
 * 비밀번호는 encHashSHA256(비밀번호 + salt) 형태로 호출한다.
 */
...
public class EncryptUtil {
     ...
     */
    private static final String addMessage = "MoveOnDataAnalysis";
     ...
     */
    private static final String key = "MoveOnTeam123456";
